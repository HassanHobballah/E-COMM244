...
class Product {
  ...
  static async update(id, data) {
    const { Name, Description, Price, StockLevel, CategoryID } = data
    await db.query(
      "UPDATE Products SET Name = ?, Description = ?, Price = ?, StockLevel = ?, CategoryID = ? WHERE ProductID = ?",
      [Name, Description, Price, StockLevel, CategoryID, id]
    )
  }
